    ...
    public static List<Auction> parseList(String data) {
        ...
        for (String token : data.split("\\|")) {
            ...
            try {
                ...
                Item item = ItemFactory.createFromCategory(p[8].trim());
                ...
                // truyền role string vào UserFactory (p[12] nếu có, không thì null)
                String roleStr = p.length > 12 ? p[12].trim() : null;
                User seller = UserFactory.createFromRole(roleStr);
